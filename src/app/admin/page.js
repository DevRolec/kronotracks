...
const page = () => {
  ...
  return (
    <div className="relative">
      <Sidebar
        className={`fixed top-0 left-0 h-screen w-1/2 bg-black/70 shadow-md z-50 transform transition-transform duration-300 ease-in-out  bottom-0 ${
        ...
        <section>
          ...
          <div className="flex justify-end py-7">
            <div
              ...
              className={` menu-bg w-[90px] p-2 rounded-md text-white flex items-center justify-center  ${
